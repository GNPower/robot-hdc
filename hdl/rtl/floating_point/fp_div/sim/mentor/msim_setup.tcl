...
# ----------------------------------------
# ACDS 23.3 104 win32 2023.11.23.21:06:28
...
alias file_copy {
  ...
  set normalized_src [fp_div::normalize_path "$file"]
  set normalized_dest [fp_div::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [fp_div::get_dpi_libraries "$QSYS_SIMDIR"]]
