...
from hdc.components.elements import UniformAngles
from hdc.components.similarity import AngleDistance
from hdc.components.bundling import AnglesOfElementAddition

# Check similarity metric works
a = UniformAngles(10)
b = UniformAngles(10)
sim = AngleDistance(a, b)
print(sim)