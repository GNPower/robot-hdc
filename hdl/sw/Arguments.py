...
def ParseArgs_BindKernel():
    parser.add_argument("output", type=str, help="Name of the output file")

def ParseArgs_BindKernelMapper():
    parser.add_argument("output", type=str, help="Name of the output file")
    parser.add_argument("-l", "--hv-length", type=int, default=4, help="Length of the hypervectors to generate")
    parser.add_argument("-m", "--hv-max", type=int,  default=4, help="The maximum size of hypervectors which can be stored in memory. Must be >= --hv-length")
    parser.add_argument("-i", "--implementation", type=int, default=1, help="Binder implementation to use (1 = ElementMultiplication_F)")

def ParseArgs_SimilarityKernel():
    parser.add_argument("output", type=str, help="Name of the output file")
    parser.add_argument("-n", "--num-inputs", type=int, default=3, help="Number of kernel inputs to generate (*2 for HVA and HVB)")