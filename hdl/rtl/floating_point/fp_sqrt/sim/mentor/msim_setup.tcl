...
# ----------------------------------------
# ACDS 23.3 104 win32 2023.11.23.21:09:21
...
alias file_copy {
  ...
  set normalized_src [fp_sqrt::normalize_path "$file"]
  set normalized_dest [fp_sqrt::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [fp_sqrt::get_dpi_libraries "$QSYS_SIMDIR"]]
